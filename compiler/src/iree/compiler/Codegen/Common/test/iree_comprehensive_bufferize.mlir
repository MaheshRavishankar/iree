...
func.func @cast_to_ragged_shape_static() -> tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>> {
  %c0 = arith.constant 0 : index
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%column_lengths)
      ...
      -> tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>
  return %0 : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
//  CHECK-SAME:       -> memref<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>
...
func.func @cast_to_ragged_shape_dynamic(%num_ragged_rows : index, %d0 : index, %d1 : index, %d2 : index)
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%column_lengths)
      ...
      -> tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  return %0 : tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
//       CHECK:   %[[RAGGED:.+]] = iree_tensor_ext.cast_to_ragged_shape %[[SOURCE]]
//  CHECK-SAME:       ragged_dim(1) column_lengths(%[[COLUMN_LENGTHS]])
//  CHECK-SAME:       -> memref<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
//       CHECK:   %[[RAGGED_TENSOR:.+]] = bufferization.to_tensor %[[RAGGED]]
//       CHECK:   return %[[RAGGED_TENSOR]]
// -----
