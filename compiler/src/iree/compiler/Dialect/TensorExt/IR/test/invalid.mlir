...
util.func public @raggedDimError(%source : tensor<10x20x30xf32>,
    %columnLengths : tensor<4xindex>) -> tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>> {
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(3) column_lengths(%columnLengths)
      : (tensor<10x20x30xf32>, tensor<4xindex>) -> tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @zeroDColumnLengths(%source : tensor<10x20x30xf32>,
    %columnLengths : tensor<index>) -> tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>> {
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<10x20x30xf32>, tensor<index>) -> tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @twoDcolumnLengths(%source : tensor<10x20x30xf32>,
    %columnLengths : tensor<4x2xindex>) -> tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{expected `column_lengths` to be of rank 1}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<10x20x30xf32>, tensor<4x2xindex>) -> tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<10x3x8x30xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @resultRankSameAsSourceRank(%source : tensor<?x?x?xf32>,
    ...
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      ...
      -> tensor<?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @resultRankTwoMoreThanSourceRank(%source : tensor<?x?x?xf32>,
    %columnLengths : tensor<?xindex>, %numRaggedRows : index,
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{expected result rank to be 4, i.e. one more than the source rank, but got 5}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      num_ragged_rows(%numRaggedRows) : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<?xindex>)
      -> tensor<?x?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
// Mismatched between `ragged_tensor` attr used and `ragged_dim` specified.
util.func public @mismatchedRaggedTensorAttr(%source : tensor<?x?x?xf32>,
    %columnLengths : tensor<?xindex>, %numRaggedRows : index,
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<0>> {
  // expected-error @+1 {{mismatch in specified `ragged_dim` value of 1 and `raggedRow` value in the sparse encoding 0}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      num_ragged_rows(%numRaggedRows) : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<?xindex>)
      -> tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<0>>
  util.return %0 : tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<0>>
}
...
util.func public @staticColumnLenghtsWithDynamicNumRaggedRows(%source : tensor<?x?x?xf32>,
    ...
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{invalid to have static dimensions for `column_lenghts` when `num_ragged_rows` is dynamic}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
...
util.func public @staticResultDimWithDynamicNumRaggedRows(%source : tensor<?x?x?xf32>,
    %columnLengths : tensor<?xindex>, %numRaggedRows : index,
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      num_ragged_rows(%numRaggedRows) : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<?xindex>)
      -> tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @dynamicColumnLengthWithStaticNumRaggedRows(%source : tensor<?x?x?xf32>,
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<?xindex>) -> tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @unitColumnLengthWithStaticNumRaggedRows(%source : tensor<?x?x?xf32>,
  ...
  // expected-error @+1 {{expected shape of `column_lengths` to be static and greater than 1 when `num_ragged_rows` is unspecified, i.e. number of ragged rows is statically known}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<1xindex>) -> tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x2x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @dynamicResultDimWithStaticNumRaggedRows(%source : tensor<?x?x?xf32>,
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<4xindex>) -> tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x?x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @dynamicResultDimWithStaticNumRaggedRows(%source : tensor<?x?x?xf32>,
    %columnLengths : tensor<4xindex>,
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x4x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{expected shape of dimension 1 of result, i.e. the `ragged_dim`, to be static and equal to 3 when `num_ragged_rows` is unspecified, i.e number of ragged rows is statically known}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<4xindex>) -> tensor<?x4x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x4x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @staticRaggedColumnLengths(%source : tensor<?x?x?xf32>,
    ...
    %d0 : index, %d1 : index, %d2 : index) -> tensor<?x3x4x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{expected dimension 2 of result, i.e. `ragged_dim` + 1, to be dynamic}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      avg_ragged_column_length(%avgColumnLength)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<4xindex>) -> tensor<?x3x4x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x3x4x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @mismatchSourceAndResultDims0(%source : tensor<?x?x?xf32>,
    %columnLengths : tensor<4xindex>, %d0 : index, %d1 : index, %d2 : index) -> tensor<2x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<4xindex>) -> tensor<2x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<2x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @mismatchSourceAndResultDims1(%source : tensor<4x?x?xf32>,
    ...
    -> tensor<2x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> {
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<4x?x?xf32>{%d0, %d1}, tensor<4xindex>) -> tensor<2x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<2x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @mismatchSourceAndResultDims3(%source : tensor<?x?x4xf32>,
  ...
  // expected-error @+1 {{expected shape of dimension 3 of result to match the shape of dimension 2 of source, but got ? and 4 respectivel}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x4xf32>{%d0, %d1}, tensor<4xindex>) -> tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
...
util.func public @mismatchSourceAndResultDims4(%source : tensor<?x?x4xf32>,
    %columnLengths : tensor<4xindex>, %d0 : index, %d1 : index)
    -> tensor<?x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{expected shape of dimension 3 of result to match the shape of dimension 2 of source, but got 5 and 4 respectivel}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x4xf32>{%d0, %d1}, tensor<4xindex>) -> tensor<?x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @mismatchSourceAndResultDims4(%source : tensor<?x?x?xf32>,
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1, %d2}, tensor<4xindex>) -> tensor<?x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @insufficientSourceDynamicDims(%source : tensor<?x?x?xf32>,
  ...
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<?x?x?xf32>{%d0, %d1}, tensor<4xindex>) -> tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @extraSourceDynamicDims(%source : tensor<2x?x5xf32>,
    %columnLengths : tensor<4xindex>, %d0 : index, %d1 : index, %d2 : index)
    -> tensor<2x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>> {
  // expected-error @+1 {{mismatch in number of dynamic dimensions specified for source, expected 1 values, got 2}}
  %0 = iree_tensor_ext.cast_to_ragged_shape %source ragged_dim(1) column_lengths(%columnLengths)
      : (tensor<2x?x5xf32>{%d0, %d1}, tensor<4xindex>) -> tensor<2x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>>
  util.return %0 : tensor<2x3x?x5xf32, #iree_tensor_ext.ragged_tensor<1>>
}
...
util.func public @resultHasEncoding(%source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>)
    -> tensor<10x30xf32, #iree_tensor_ext.ragged_tensor<0>> {
  // expected-error @+1 {{expected result type to not have an encoding}}
  %0 = iree_tensor_ext.linearize_ragged_dims %source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>> -> tensor<10x30xf32, #iree_tensor_ext.ragged_tensor<0>>
  util.return %0 : tensor<10x30xf32, #iree_tensor_ext.ragged_tensor<0>>
}
...
util.func public @wrongResultRank(%source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>, %d0 : index) -> tensor<?xf32> {
  // expected-error @+1 {{expected result rank to be 3 (source rank - number of sparse dimensions + 1), but got 1}}
  %0 = iree_tensor_ext.linearize_ragged_dims %source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>> -> tensor<?xf32>{%d0}
...
util.func public @resultRankTooHigh(%source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>) -> tensor<10x3x?x30xf32> {
  // expected-error @+1 {{expected result rank to be 3 (source rank - number of sparse dimensions + 1), but got 4}}
  %0 = iree_tensor_ext.linearize_ragged_dims %source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>> -> tensor<10x3x?x30xf32>
...
util.func public @dimensionNotPreserved(%source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>>) -> tensor<5x?x30xf32> {
  // expected-error @+1 {{expected source dimension 0 with size 10 to be preserved in result dimension 0 but got size 5}}
  %0 = iree_tensor_ext.linearize_ragged_dims %source : tensor<10x3x?x30xf32, #iree_tensor_ext.ragged_tensor<1>> -> tensor<5x?x30xf32>
...
util.func public @wrongDynamicDimCount(%source : tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>,
    %d0 : index, %d1 : index, %d2 : index, %d3 : index)
    -> tensor<?x?x?xf32> {
  // expected-error @+1 {{expected 3 dynamic dimension values, but got 4}}
  %0 = iree_tensor_ext.linearize_ragged_dims %source : tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> -> tensor<?x?x?xf32>{%d0, %d1, %d2, %d3}
...
util.func public @missingDynamicDims(%source : tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>>)
    -> tensor<?x?x?xf32> {
  // expected-error @+1 {{expected 3 dynamic dimension values, but got 0}}
  %0 = iree_tensor_ext.linearize_ragged_dims %source : tensor<?x3x?x?xf32, #iree_tensor_ext.ragged_tensor<1>> -> tensor<?x?x?xf32>
  util.return %0 : tensor<?x?x?xf32>
}
